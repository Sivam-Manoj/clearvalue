          ...
          >
            <div className="relative w-full sm:w-[98%] max-w-none sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl h-[100dvh] sm:h-[96dvh] max-h-[100dvh] sm:max-h-[96dvh] overflow-hidden flex flex-col rounded-none sm:rounded-2xl border-0 sm:border border-rose-200/30 bg-black/30 ring-0 sm:ring-1 ring-black/50 shadow-2xl">
              <div className="relative flex-1 min-h-0 bg-black">
                ...
                >
                  {/* Zoom: above controls for clarity */}
                  <div className="mb-2 flex items-center gap-2 rounded-xl bg-white/10 px-3 py-2 ring-1 ring-white/20 backdrop-blur">
                  ...
                  <div className="grid grid-cols-[2fr_1fr_2fr] items-center gap-2 w-full">
                    <button
                      ...
                      className="h-11 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 text-xs font-semibold text-white ring-1 ring-white/10 hover:bg-blue-500 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
                    ...
                    <button
                      type="button"
                      onClick={closeCamera}
                      className="h-16 sm:h-20 w-full inline-flex items-center justify-center rounded-2xl bg-gradient-to-b from-rose-500 to-rose-600 text-white shadow-[0_8px_0_0_rgba(190,18,60,0.45)] ring-2 ring-rose-300/60 hover:from-rose-400 hover:to-rose-600 active:translate-y-0.5 active:shadow-[0_4px_0_0_rgba(190,18,60,0.45)] focus:outline-none cursor-pointer"
                      aria-label="Done"
                      title="Done"
                    >
                    ...
                    <button
                      type="button"
                      onClick={goNextLot}
                      className="h-11 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-green-600 px-3 text-xs font-semibold text-white ring-1 ring-white/10 hover:bg-green-500 cursor-pointer"
                      aria-label="Next lot"
                    >
