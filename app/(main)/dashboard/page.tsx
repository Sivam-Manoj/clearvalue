  ...
  return (
    <Stack spacing={3}>
      <PageHeader
        ...
        title={`${mounted ? greeting : "Welcome"}, ${user?.username || user?.email || "there"}`}
        description="Monitor appraisal activity, launch new report workflows, and manage recent output from one responsive workspace."
        action={
          <Button
            variant="contained"
